...
laws s3api create-bucket --bucket oswasp-zap-report-data
...
laws s3api put-bucket-acl --bucket oswasp-zap-report-data --acl public-read-write
...
laws s3api put-bucket-notification-configuration --bucket oswasp-zap-report-data --notification-configuration file://notification.json
