...
export type ListResponse = {
  promise(): Promise<
    PromiseResult<StepFunctions.ListStateMachinesOutput, AWSError>
  >;
};

export type CreateResponse = {
  promise(): Promise<
    PromiseResult<StepFunctions.CreateStateMachineOutput, AWSError>
  >;
};
...
export interface Runner {
  listStateMachines(
    ...
    callback?: (
      err: AWSError,
      data: StepFunctions.ListStateMachinesOutput
    ) => void
  ): ListResponse;
  ...
  createStateMachine(
    ...
    callback?: (
      err: AWSError,
      data: StepFunctions.CreateStateMachineOutput
    ) => void
  ): CreateResponse;
